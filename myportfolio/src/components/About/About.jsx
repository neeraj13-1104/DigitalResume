...
/>
        ...
        {/* right side */}
        <div className='md:w-1/ flex justify-center md:justify-end'>
        ...
        gyroscope={true}
        >
        {/* <img src={profileImage} alt="Neeraj Lalwani" className="w-full h-full rounded-full object-cover drop-shadow-[0_10px_20px_rgba(130,69,236,0.5)]" /> */}
        </Tilt>
        </div>
